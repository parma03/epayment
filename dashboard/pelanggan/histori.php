...
// Bind parameter id_user dari session
...
<head>
    ...
    <title>Manajemen Transaksi & Histori &mdash; Stisla</title>
...
<body>
            ...
            <div class="main-content">
                <section class="section">
                    <div class="section-header">
                        <h1><i class="fas fa-shipping-fast mr-3"></i>Manajemen Transaksi & Histori</h1>
                        <div class="section-header-breadcrumb">
                            <div class="breadcrumb-item active"><a href="index.php"><i
                                        class="fas fa-home mr-1"></i>Dashboard</a></div>
                            <div class="breadcrumb-item"><i class="fas fa-history mr-1"></i>Transaksi & Histori</div>
                        </div>
                    </div>
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h4><i class="fas fa-table mr-2"></i>Transaksi yang Telah Selesai</h4>
                                        <div class="card-header-action">
                                            <div class="badge badge-success badge-lg">
                                                <i class="fas fa-check-circle mr-1"></i>
                                                Total: <?php echo count($transactions); ?> transaksi selesai
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card-body">
                                        <?php if (empty($transactions)): ?>
                                            <div class="empty-state" data-height="400">
                                                ...
                                                <h2>Tidak Ada Histori Transaksi</h2>
                                                <p class="lead">Belum ada transaksi yang telah diselesaikan.</p>
                                            </div>
                                        <?php else: ?>
                                                ...
                                                <table class="table table-striped table-hover" id="table-1">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th><i class="fas fa-calendar mr-1"></i>Tanggal Selesai</th>
    ...
    <script>
        ...
        function viewTransaction(transaction) {
            ...
            $('#viewPaymentStatus').removeClass().addClass('badge badge-success').html('<i class="fas fa-check-circle mr-1"></i>SELESAI');
