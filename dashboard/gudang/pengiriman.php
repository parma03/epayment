...
// Query untuk mengambil data transaksi yang memiliki status pengiriman 'disiapkan' dengan detail lengkap
$stmt = $pdo->prepare("
    SELECT 
        t.*,
        td.nama_barang,
...
<body>
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h4><i class="fas fa-table mr-2"></i>Transaksi Siap Dikirim</h4>
                                        <div class="card-header-action">
                                            <div class="badge badge-info badge-lg">
                                                <i class="fas fa-truck mr-1"></i>
                                                Total: <?php echo count($grouped_transactions); ?> transaksi siap dikirim
                                            </div>
                                        </div>
                                    </div>
                                    <div class="card-body">
                                        <?php if (empty($grouped_transactions)): ?>
                                            <div class="empty-state" data-height="400">
                                                ...
                                                <h2>Tidak Ada Transaksi Siap Dikirim</h2>
                                                <p class="lead">Belum ada transaksi yang siap untuk dikirim.</p>
                                            </div>
                                        <?php else: ?>
                                                ...
                                                <table class="table table-striped table-hover" id="table-1">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th><i class="fas fa-shipping-fast mr-1"></i>Status</th>
                ...
                <div class="modal-footer">
                    <form id="confirmForm" method="POST" action="">
                        ...
                        <button type="submit" class="btn btn-primary btn-lg">
                            <i class="fas fa-truck mr-1"></i>Ya, Kirim Sekarang
                        </button>
                    </form>
                </div>
            </div>
    ...
    <script>
        ...
        $('button[onclick^="viewTransaction"], button[onclick^="printInvoice"], button[onclick^="confirmDelivery"]').on('click', function() {
            let $btn = $(this);
