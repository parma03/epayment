        ...
        try {
            switch ($_POST['action']) {
                case 'create':
                    ...
                    $_SESSION['alert_message'] = 'Data Pelanggan berhasil ditambahkan!';
                ...
                case 'update':
                    ...
                    $_SESSION['alert_message'] = 'Data Pelanggan berhasil diupdate!';
                    $_SESSION['alert_type'] = 'success';
                    $_SESSION['alert_title'] = 'Sukses!';
                    $_SESSION['alert_icon'] = 'fas fa-check-circle';
                    break;
                ...
                case 'delete':
                    ...
                    $_SESSION['alert_message'] = 'Data Pelanggan berhasil dihapus!';
                    $_SESSION['alert_type'] = 'success';
                    $_SESSION['alert_title'] = 'Sukses!';
                    $_SESSION['alert_icon'] = 'fas fa-check-circle';
                    break;
...
// Fetch all Pelanggan
$stmt = $pdo->prepare("SELECT * FROM tb_user WHERE role = 'Pelanggan' ORDER BY created_at DESC");
$stmt->execute();
...
<head>
    ...
    <title>Pelanggan Management &mdash; Stisla</title>
...
<body>
            ...
            <div class="main-content">
                <section class="section">
                    <div class="section-header">
                        <h1><i class="fas fa-users-cog mr-3"></i>Pelanggan Management</h1>
                        <div class="section-header-breadcrumb">
                            <div class="breadcrumb-item active"><a href="index.php"><i
                                        class="fas fa-home mr-1"></i>Dashboard</a></div>
                            <div class="breadcrumb-item"><i class="fas fa-user-shield mr-1"></i>Pelanggan</div>
                        </div>
                    </div>
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h4><i class="fas fa-table mr-2"></i>Data Pelanggan</h4>
                                        <div class="card-header-action">
                                            <button type="button" class="btn btn-primary btn-lg" data-toggle="modal"
                                                data-target="#addModal">
                                                <i class="fas fa-plus-circle mr-2"></i>Tambah Pelanggan
                                            </button>
                                        </div>
                                    </div>
                                    <div class="card-body">
            ...
            <div class="modal-content">
                <div class="modal-header bg-danger">
                    <h5 class="modal-title text-white" id="deleteModalLabel">
                        <i class="fas fa-exclamation-triangle mr-2"></i>Konfirmasi Hapus Pelanggan
                    </h5>
                    <button type="button" class="close text-white" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="text-center mb-4">
                            <div class="alert alert-warning" role="alert">
                                ...
                                <p class="mb-0">Anda akan menghapus Pelanggan dengan email:</p>
                                ...
                                <div class="card border-danger">
                                    <div class="card-body text-center">
                                        ...
                                        <p class="card-text text-muted">
                                            Data Pelanggan akan dihapus secara permanen dari sistem.
            ...
            <div class="modal-content">
                <div class="modal-header bg-info">
                    <h5 class="modal-title text-white" id="viewModalLabel">
                        <i class="fas fa-eye mr-2"></i>Detail Pelanggan
                    </h5>
                    <button type="button" class="close text-white" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $('.dataTables_filter input').addClass('form-control').attr('placeholder', 'Cari Pelanggan...');
        ...
        // Enhanced delete Pelanggan function with SweetAlert2
        function deleteAdmin(id, email) {
            Swal.fire({
                title: '⚠️ Konfirmasi Hapus',
                html: `Apakah Anda yakin ingin menghapus Pelanggan:<br><strong class="text-danger">${email}</strong>?`,
                icon: 'warning',
