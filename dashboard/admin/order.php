...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action']) && $_POST['action'] === 'confirm_order') {
    try {
        ...
        // Cek apakah transaksi sudah ada di tb_pengiriman
        $check_stmt = $pdo->prepare("SELECT id_pengiriman FROM tb_pengiriman WHERE id_transaksi = ?");
        $check_stmt->execute([$id_transaksi]);

        if ($check_stmt->rowCount() > 0) {
            $_SESSION['alert_message'] = 'Pesanan sudah dikonfirmasi sebelumnya!';
            $_SESSION['alert_type'] = 'warning';
            $_SESSION['alert_title'] = 'Peringatan!';
            $_SESSION['alert_icon'] = 'fas fa-exclamation-triangle';
        } else {
            // Insert ke tb_pengiriman dengan status 'disiapkan'
            $insert_stmt = $pdo->prepare("
                INSERT INTO tb_pengiriman (id_transaksi, status, created_at) 
                VALUES (?, 'disiapkan', NOW())
            ");

            if ($insert_stmt->execute([$id_transaksi])) {
                $_SESSION['alert_message'] = 'Pesanan berhasil dikonfirmasi dan sedang disiapkan!';
                $_SESSION['alert_type'] = 'success';
                $_SESSION['alert_title'] = 'Berhasil!';
                $_SESSION['alert_icon'] = 'fas fa-check-circle';
            } else {
                $_SESSION['alert_message'] = 'Gagal mengkonfirmasi pesanan. Silakan coba lagi.';
...
<head>
    ...
    <title>Manajemen Transaksi & Order &mdash; Stisla</title>
...
<body>
            ...
            <div class="main-content">
                <section class="section">
                    <div class="section-header">
                        <h1><i class="fas fa-shipping-fast mr-3"></i>Manajemen Transaksi & Order Data</h1>
                        <div class="section-header-breadcrumb">
                            <div class="breadcrumb-item active"><a href="index.php"><i
                                        class="fas fa-home mr-1"></i>Dashboard</a></div>
                            <div class="breadcrumb-item"><i class="fas fa-box mr-1"></i>Order Data</div>
                        </div>
                    </div>
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h4><i class="fas fa-table mr-2"></i>Transaksi Siap Kirim</h4>
                                    ...
                                    <div class="card-body">
                                        <?php if (empty($transactions)): ?>
                                            <div class="empty-state" data-height="400">
                                                ...
                                                <p class="lead">Belum ada transaksi yang siap untuk diproses pengiriman.</p>
                                            </div>
                                        <?php else: ?>
                                                                ...
                                                                <td class="text-center">
                                                                    <div class="btn-group" role="group">
                                                                        ...
                                                                        <button type="button" class="btn btn-primary btn-sm"
                                                                            onclick="confirmOrder(<?php echo $trans['id_transaksi']; ?>, '<?php echo htmlspecialchars($trans['order_id']); ?>')"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <h5 class="text-center mb-3">Apakah Anda yakin ingin mengkonfirmasi pesanan ini?</h5>
                    <div class="alert alert-info">
                        <i class="fas fa-info-circle mr-2"></i>
                        <strong>Order ID:</strong> <span id="confirmOrderId"></span>
                    </div>
                    <p class="text-muted text-center">
                        Setelah dikonfirmasi, pesanan akan masuk ke dalam daftar pengiriman dengan status "Disiapkan"
                ...
                <div class="modal-footer">
                    ...
                    <form method="POST" style="display: inline;">
                        ...
                        <input type="hidden" name="id_transaksi" id="confirmTransactionId">
                        <button type="submit" class="btn btn-primary btn-lg">
                            <i class="fas fa-check mr-1"></i>Ya, Konfirmasi
                        </button>
                    </form>
                </div>
            </div>
    ...
    <script>
        ...
        function confirmOrder(transactionId, orderId) {
            $('#confirmTransactionId').val(transactionId);
